...
const InvestorProfile = () => {
    ...
    const fetchInvestorProfile = async () => {
      ...
      try {
        ...
        if (response.data.status === 200) {
          ...
          setImageError(false); // Reset image error when new investor is loaded
        } else {
  ...
  const isProfilePublic = investor?.profilePublic === true;
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="flex flex-col lg:flex-row gap-6">
            ...
            <div className="w-full lg:w-2/3">
                ...
                <CardContent>
                  {isProfilePublic ? (
                    ...
                    <div className="p-6 bg-gray-50 border border-gray-200 rounded-md text-center">
                      <p className="text-gray-500 italic">This content is private.</p>
                    </div>
                  )}
                        ...
                        <div className="border rounded-md">
                          {isProfilePublic ? (
                            ...
                            <div className="p-8 text-center">
                              <p className="text-gray-500 italic">This content is private.</p>
                              <p className="text-sm text-gray-400 mt-2">Contact the investor through our messaging system to discuss investment opportunities.</p>
                            </div>
                          )}
                        </div>
                      </TabsContent>
              ...
              {!isProfilePublic && (
                <div className="flex items-center justify-center py-4 px-6 bg-yellow-50 border border-yellow-200 rounded-lg">
                  <ShieldCheck className="h-5 w-5 text-yellow-600 mr-2" />
                  <p className="text-yellow-600 text-sm">
                    This investor has chosen to keep their profile private. Contact information is available for communication.
                  </p>
                </div>
              )}
              {isProfilePublic && (
                <div className="flex items-center justify-center py-4 px-6 bg-blue-50 border border-blue-200 rounded-lg">
                  ...
                  <p className="text-blue-600 text-sm">
                    This is a public investor profile.
                  </p>
                </div>
              )}
