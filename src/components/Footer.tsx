    ...
    <footer className="bg-lebanese-navy text-white">
      <div className="max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div>
            ...
            <p className="text-sm text-gray-300">
              The platform that connects Lebanese businesses with investors to
              revitalize the economy and create growth opportunities.
            </p>
          </div>
          <div>
        ...
        <div className="mt-8 border-t border-gray-700 pt-8 flex flex-col md:flex-row justify-between">
          <p className="text-sm text-gray-300">
            © 2025 LebVest. All rights reserved.
          </p>
